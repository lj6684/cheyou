...
<script type="text/javascript">
	...
	// 检查表单输入，不允许查询条件为空
	function checkInput () {		
		var inputObj = $("#wipersQueryStr");;
		var checkObj = $(":checkbox[name='wipersSupplyItem']");;
	...
	<div id="search_begin">
		<div id="tab-container" class="tab-container" align="center">
			<ul class="etabs">
				...
				<li class="tab"><a href="#" id="current">雨刷</a></li>
				<li class="tab"><a href="../shachepian/">刹车片</a></li>
			</ul>
			<div class="clear"></div>
			<div id="spark-tab">
				<form action="query_wipers.action" method="post" onsubmit="return checkInput();" id="form">		
				<div class="brand_item">
					<s:set name="wipersSupplies" value="#{'1':'博世BOSCH', '7':'NGK', '8':'电装DENSO'}"></s:set>
					<ul>
