...
<body>
<form action="supply_add.action" method="post">
<table width="98%" border="0" cellpadding="0" cellspacing="0"
	...
	<tr style="height: 50px">
		...
		<td style="width: 70%; align: left">供货商品牌名称:&nbsp;<input type="text"
			name="supplyName" style="width: 150px"></input>&nbsp;<span class="red">*</span>&nbsp;&nbsp;&nbsp;&nbsp;
...
<table width="98%" border="0" cellpadding="4" cellspacing="1"
	...
	<tr class="CTitle">
		<td height="22" colspan="7" align="center" style="font-size: 16px">已登记供货商品牌列表</td>
	</tr>
	<tr bgcolor="#EEEEEE">
