...
<table width="98%" border="0" cellpadding="0" cellspacing="0"
	...
	<tr style="height: 50px">
		...
		<td style="width: 100px; align: left">供货商序号:</td>
		<td style="align: left">&nbsp;<input type="text" name="orderIndex" style="width: 150px"></input>&nbsp;<span class="red">*</span></td>
	</tr>
	<tr style="height: 50px">
		<td style="width: 1%; align: left">&nbsp;</td>
		<td style="width: 100px; align: left">供货商品牌名称:
		</td>
		<td style="align:left"><input type="text" name="supplyName" style="width: 150px"></input>&nbsp;<span class="red">*</span></td>
	</tr>
	<tr style="height: 50px">
		<td style="width: 1%; align: left">&nbsp;</td>
		<td style="width: 100px; align: left">供货商图片:</td>
		<td style="align: left">&nbsp;<input type="file" name="img"></input>
		</td>
	</tr>
	<tr style="height: 50px">
		<td style="width: 1%; align: left">&nbsp;</td>
...
<table width="98%" border="0" cellpadding="4" cellspacing="1"
	...
	<tr bgcolor="#EEEEEE">
		<td width="3%" align="center" height="30">序号</td>
		<td width="20%">品牌名称</td>
		<td>操作</td>
	</tr>
	<s:iterator value="#request.supplies" id="supply" status="st">
	<tr bgcolor="#FFFFFF">
		<td height="20"><s:property value="orderIndex"></s:property></td>
