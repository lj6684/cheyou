...
<div class="wrap">
	...
	<div id="search_begin">
		...
		<div class="accessory_item">
			<ul>
				<li id="nav1"><a href="index.jsp" class="current">三滤+空调滤<span></span></a></li>
	...
	<div id="search_result">
		...
		<table cellspacing="0" class="detailtb">
			...
			<tr>
				...
				<td class="td_rgt"><a href="detail/sanlv_<s:property value="#request.filters[styleFullName][name].filterId"/>.html">详情>></a></td>
			</tr>
			</s:iterator>
		</table>
