...
<div class="wrap">
	<div id="topbar"/></div>
	<div id="logobar"><a href="/bosch/"><img src="../images/bosch.gif" alt="博世logo" border="0"/></a><a href="/"><img src="../images/logo_fenzhan.gif" alt="点击回首页" border="0"/></a></div>
	<!--search begin-->
	...
	<div id="search_begin">
		...
		<div class="accessory_item">
			<ul>
				<li id="nav1"><a href="/bosch/" class="current">博世三滤<span></span></a></li>
		...
		<div class="brand_item">
			...
			<s:else>
				<s:checkboxlist list="#supplies" name="supplyItem" theme="simple" value="{'2', '1'}"></s:checkboxlist>
			</s:else>
			</ul>
			<div class="clear"></div>
		</div>
